...
const Questions = () => {
  ...
  const[currenQuestionState, setCurrentQuestionState] = useState(1);
    ...
    <div className="content">
        ...
        <div className="progress-bar">
          <div className='bar-section'>
            ...
            <div className='bar-title' style={{ position: 'absolute', left: '5cm', top: '2cm' }}>
              STRONG
              <progress value={isprogress} className='progress1' max="24" style={{ position: 'absolute', left: '-1.2cm', top: '-30px' }}></progress>
              </div>
      ...
      <div className="ques-slide">
        ...
        <div className="slide-container" >
          ...
          <Link to="/questions" className="prev" style={{positon:'absolute', left: '4cm', top:'500px'}} onClick={handlePrev}>
          {'<---'}Prev
        </Link>
        {showNextButton && (
          <button className="next" style={{position: 'absolute', left: '2cm', top:'-4cm', color:'black'}} onClick={handleNext}>
            Next
          </button>
        )}
        </div>
